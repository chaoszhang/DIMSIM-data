...
for j in 200 500; do 
	cd /home/chaos/scratch/tree/$PBS_ARRAYID/$j
	rm *beast*
	python /home/chaos/immuno/reconstruction_tools/beastXML.py /home/chaos/immuno/tree/real/$PBS_ARRAYID/$j/seq_with_root.fasta > beast.xml
